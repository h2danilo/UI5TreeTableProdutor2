...
sap.ui.define(
  ...
  function (library, Control, CoreLibrary, InfoLabelRenderer) {
     ...
     */
    var InfoLabel = Control.extend(
      "br.com.idxtec.ui5Template.ext.InfoLabel",
      /** @lends sap.tnt.InfoLabel.prototype */ {
        metadata: {
          ...
          properties: {
             ...
             */
            colorScheme: { type: "string", group: "Misc", defaultValue: "7" },
            /**
    ...
    InfoLabel.prototype.init = function () {
      ...
      if (
        ...
        !InfoLabelRenderer._sAriaText
      ) {
        InfoLabelRenderer._sAriaText = sap.ui
          .getCore()
          .getLibraryResourceBundle("sap.tnt")
          .getText("INFOLABEL_DEFAULT");
        InfoLabelRenderer._sAriaTextEmpty = sap.ui
          .getCore()
          .getLibraryResourceBundle("sap.tnt")
          .getText("INFOLABEL_EMPTY");
      }
    };
